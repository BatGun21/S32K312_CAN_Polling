...
#define LPUART_UART_IP_TIMEOUT_VALUE_US         (99999999)
...
#define LPUART_UART_IP_ENABLE_INTERNAL_LOOPBACK  (STD_OFF)
    ...
    #define LPUART_UART_IP_ENABLE_INTERNAL_LOOPBACK_PER_INSTANCE  {(boolean) FALSE, (boolean) FALSE, (boolean) FALSE, (boolean) FALSE, (boolean) FALSE, (boolean) FALSE, (boolean) FALSE, (boolean) FALSE}
#endif
