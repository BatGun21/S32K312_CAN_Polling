...
/* #define ECUDB_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (ECUDB_USE_DIAG_MONITORS) and define below
