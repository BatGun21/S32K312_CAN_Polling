...
typedef enum
{
#ifdef FLEXCAN_HRTIMERSRC_STM0_VALUE
    FLEXCAN_HRTIMERSRC_STM0 = FLEXCAN_HRTIMERSRC_STM0_VALUE
#endif /* FLEXCAN_HRTIMERSRC_STM0_VALUE */
#ifdef FLEXCAN_HRTIMERSRC_EMAC_VALUE
    ,FLEXCAN_HRTIMERSRC_EMAC = FLEXCAN_HRTIMERSRC_EMAC_VALUE
#endif /* FLEXCAN_HRTIMERSRC_EMAC_VALUE */
