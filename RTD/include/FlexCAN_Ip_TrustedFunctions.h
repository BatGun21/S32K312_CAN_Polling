...
#define FLEXCAN_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION_H               3
...
/**
 *  @brief Clears Enhanced RxFifo message buffers.
 */
extern void FlexCAN_ClearOutputEnhanceFIFO(FLEXCAN_Type * base);
 ...
 */
extern Flexcan_Ip_StatusType FlexCAN_Ip_ConfigEnhancedRxFifo_Privileged(uint8 instance,
