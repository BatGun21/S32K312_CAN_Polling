...
#define FLEXCAN_IP_HWACCESS_SW_MAJOR_VERSION_C               3
...
#if (FLEXCAN_IP_FEATURE_HAS_ENHANCED_RX_FIFO == STD_ON)
static volatile uint8 filterIdMap[FLEXCAN_IP_ENHANCED_RXFIFO_FILTERDEPTH];
...
void FlexCAN_SetEnhancedRxFifoFilter(FLEXCAN_Type * base, const Flexcan_Ip_EnhancedIdTableType * idFilterTable)
{
    ...
    for (i = 0U; i < (NumOfExtIDFilter + NumOfStdIDFilter); i++)
    {
        ...
        {
            Val = 0U;
            filterIdMap[NumOfExtIDFilter+j]=i;
